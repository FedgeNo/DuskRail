...
assert_same('statistics table has six compact rows', 6, $xpath -> query('//table/tbody/tr') -> length);
assert_same('statistics table alternates heading rows', 3, $xpath -> query('//table/tbody/tr[@class="CrawlStatisticsHeadings"]') -> length);
assert_same('statistics table alternates value rows', 3, $xpath -> query('//table/tbody/tr[@class="CrawlStatisticsValues"]') -> length);
